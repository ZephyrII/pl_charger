...
class MyDataModule(pl.LightningDataModule):
    ...
    def __init__(
        ...
        super().__init__()
        dataset = MNIST(_DATASETS_PATH, train=True, download=False, transform=transforms.ToTensor())
        self.mnist_test = MNIST(_DATASETS_PATH, train=False, download=False, transform=transforms.ToTensor())
...
def cli_main():
    cli = LightningCLI(ChargerKpts, MyDataModule, seed_everything_default=1234)
